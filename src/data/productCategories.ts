...
const getProductImage = (name: string, specs: string): string => {
  ...
  if (name === "Smart Motion Sensor Moon Light") {
    if (specs.includes("10W")) {
      return "/products/Firefly_Gemini Flash_Smart Motion Sensor Moon Light 415356.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart Motion Sensor Moon Light 744032.jpg";
  }
  
  // Smart LED Gate Light
  if (name === "Smart LED Gate Light") {
    if (specs.includes("20W")) {
      return "/products/Firefly_Gemini Flash_Smart LED Gate Light 392200.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart LED Gate Light 415356.jpg";
  }
  
  // Smart LED Flood Light
  if (name === "Smart LED Flood Light") {
    if (specs.includes("50W")) {
      return "/products/Firefly_Gemini Flash_Smart LED Flood Light 392200.jpg";
    }
    if (specs.includes("100W")) {
      return "/products/Firefly_Gemini Flash_Smart LED Flood Light 715976.jpg";
    }
    if (specs.includes("150W")) {
      return "/products/Firefly_Gemini Flash_Smart LED Flood Light 793088.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart LED Flood Light 827906.jpg";
  }
  
  // Foot / Step Light
  if (name === "Foot / Step Light") {
    return "/products/Firefly_Gemini Flash_Foot - Step Light 715976.jpg";
  }
  
  // Smart High Bay
  if (name === "Smart High Bay") {
    if (specs.includes("50W")) {
      return "/products/Firefly_Gemini Flash_High Bay – with Sensor 498427.jpg";
    }
    if (specs.includes("100W")) {
      return "/products/Firefly_Gemini Flash_High Bay – with Sensor 715976.jpg";
    }
    if (specs.includes("150W")) {
      return "/products/Firefly_Gemini Flash_High Bay – with Sensor generate another iimages not same 282517.jpg";
    }
    return "/products/Firefly_Gemini Flash_High Bay – with Sensor generate another iimages not same 729350.jpg";
  }
  
  if (name === "Sensor Switch") {
    return "/products/Firefly_Gemini Flash_Sensor Switch 282517.jpg";
  }
  if (name === "Microwave Sensor") {
    return "/products/Firefly_Gemini Flash_Microwave Sensor 282517.jpg";
  }
  if (name === "LDR Sensor") {
    return "/products/Firefly_Gemini Flash_LDR Sensor 661646.jpg";
  }
  
  // Tube Light (Plastic)
  if (name === "Tube Light (Plastic)") {
    if (specs.includes("2 Feet") && specs.includes("10W")) {
      return "/products/Firefly_Gemini Flash_Tube Light (Plastic)_2 Feet – 10W – T5 – Box- 20-50 661646.jpg";
    }
    if (specs.includes("2 Feet") && specs.includes("20W")) {
      return "/products/Firefly_Gemini Flash_Tube Light (Plastic)_2 Feet – 20W – T5-T8 – Box- 20-50 643047.jpg";
    }
    if (specs.includes("4 Feet") && specs.includes("20W")) {
      return "/products/Firefly_Gemini Flash_Tube Light (Plastic)_4 Feet – 20W – T5 – Box- 20-50 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Tube Light (Plastic)_4 Feet – 40W – T5-T8 – Box- 20-50 643047.jpg";
  }
  
  // Tube Light (Aluminum)
  if (name === "Tube Light (Aluminum)") {
    if (specs.includes("2 Feet") && specs.includes("10W")) {
      return "/products/Firefly_Gemini Flash_Tube Light (Aluminum)_2 Feet – 10W – T5-T8 – Box- 20-50 643047.jpg";
    }
    if (specs.includes("2 Feet") && specs.includes("20W")) {
      return "/products/Firefly_Gemini Flash_Tube Light (Aluminum)_2 Feet – 20W – T5-T8 – Box- 20-50 643047.jpg";
    }
    if (specs.includes("4 Feet") && specs.includes("20W")) {
      return "/products/Firefly_Tube Light (Aluminum)_4 Feet – 20W – T5-T8 – Box- 20-50 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Tube Light (Aluminum)_4 Feet – 40W – T5-T8 – Box- 20-50 643047.jpg";
  }
  
  // Panel Light (Plastic)
  if (name === "Panel Light (Plastic)") {
    if (specs.includes("12W/15W/20W") || specs.includes("6")) {
      return "/products/Firefly_Gemini Flash_Panel Light (Plastic)_12W-15W-20W – 6- – Round-Square 643047.jpg";
    }
    if (specs.includes("10W/15W/18W") || specs.includes("5")) {
      return "/products/Firefly_Gemini Flash_Panel Light (Plastic)_10W-15W-18W – 5- – Round-Square 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Panel Light (Plastic)_7W-9W-12W – 4- – Round-Square 643047.jpg";
  }
  
  // Panel Light (Metal)
  if (name === "Panel Light (Metal)") {
    if (specs.includes("18W/22W") || specs.includes("8")) {
      return "/products/Firefly_Gemini Flash_Panel Light (Metal)_18W-22W – 8- – Round-Square 643047.jpg";
    }
    if (specs.includes("15W/18W") || specs.includes("7")) {
      return "/products/Firefly_Gemini Flash_Panel Light (Metal)_15W-18W – 7- – Round-Square 643047.jpg";
    }
    if (specs.includes("12W/15W") || specs.includes("6")) {
      return "/products/Firefly_Gemini Flash_Panel Light (Metal)_12W-15W – 6- – Round-Square 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Panel Light (Metal)_9W-12W – 5- – Round-Square 643047.jpg";
  }
  
  // Panel Light (Metal on/off)
  if (name === "Panel Light (Metal on/off)") {
    return "/products/Firefly_Gemini Flash_Panel Light (Metal on-off)_7W-9W – 4- – Round-Square 643047.jpg";
  }
  
  // Panel Light Dimming
  if (name === "Panel Light Dimming") {
    if (specs.includes("36W")) {
      return "/products/Firefly_Gemini Flash_Panel Light Dimming_36W – Size- 2×2 – Concealed 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Panel Light Dimming_50W – Size- 2×2 – Concealed 643047.jpg";
  }
  
  // Surface Light (Plastic Dim)
  if (name === "Surface Light (Plastic Dim)") {
    return "/products/Firefly_Gemini Flash_Surface Light (Plastic Dim)_12W-15W-20W – 6- – Round-Dim 643047.jpg";
  }
  
  // Surface Light (Metal)
  if (name === "Surface Light (Metal)") {
    if (specs.includes("18W/22W") || specs.includes("8")) {
      return "/products/Firefly_Gemini Flash_Surface Light (Metal)_18W-22W – 8- – Round-Square 643047.jpg";
    }
    if (specs.includes("12W/15W") || specs.includes("6")) {
      return "/products/Firefly_Gemini Flash_Surface Light (Metal)_12W-15W – 6- – Round-Square 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Surface Light (Metal)_9W-12W – 5- – Round-Square 643047.jpg";
  }
  
  // Surface Light (Metal on/off)
  if (name === "Surface Light (Metal on/off)") {
    return "/products/Firefly_Gemini Flash_Surface Light (Metal on-off)_7W-9W – 4- – Round-Square 643047.jpg";
  }
  
  // Street Light
  if (name === "Street Light") {
    if (specs.includes("24W")) {
      return "/products/Firefly_Gemini Flash_Street Light_24W – 4KV Protection – Pipe ID 45 – Lence 643047.jpg";
    }
    if (specs.includes("36W")) {
      return "/products/Firefly_Gemini Flash_Street Light_36W – 6KV Protection – Pipe ID 45 – Lence 643047.jpg";
    }
    if (specs.includes("50W")) {
      return "/products/Firefly_Gemini Flash_Street Light_50W – 6KV Protection – Pipe ID 47 – Lence 643047.jpg";
    }
    if (specs.includes("72W")) {
      return "/products/Firefly_Gemini Flash_Street Light_72W – 6KV Protection – Pipe ID 47 – Lence 643047.jpg";
    }
    if (specs.includes("100W")) {
      return "/products/Firefly_Gemini Flash_Street Light_100W – 6KV Protection – Pipe ID 47 – Lence 643047.jpg";
    }
    if (specs.includes("150W")) {
      return "/products/Firefly_Street Light_150W – 6KV Protection – Pipe ID 65 – Lence 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Street Light_200W – 6KV Protection – Pipe ID 65 – Lence 643047.jpg";
  }
  
  // Smart COB Light (Std on/off)
  if (name === "Smart COB Light (Std on/off)") {
    return "/products/Firefly_Gemini Flash_Smart COB Light (Std on-off)_7W – Concealed 643047.jpg";
  }
  
  // Smart COB Light (Std)
  if (name === "Smart COB Light (Std)") {
    if (specs.includes("15W")) {
      return "/products/Firefly_Gemini Flash_Smart COB Light (Std)_15W – Concealed 643047.jpg";
    }
    if (specs.includes("12W")) {
      return "/products/Firefly_Gemini Flash_Smart COB Light (Std)_12W – Concealed 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart COB Light (Std)_9W – Concealed 643047.jpg";
  }
  
  // Smart COB Light (Delta)
  if (name === "Smart COB Light (Delta)") {
    if (specs.includes("12W")) {
      return "/products/Firefly_Gemini Flash_Smart COB Light (Delta)_12W – Concealed 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart COB Light (Delta)_9W – Concealed 643047.jpg";
  }
  
  // Smart BulkHead Light
  if (name === "Smart BulkHead Light") {
    if (specs.includes("10W")) {
      return "/products/Firefly_Gemini Flash_Smart BulkHead Light_10W – Oblong 643047.jpg";
    }
    return "/products/Firefly_Gemini Flash_Smart BulkHead Light_20W – Oblong 501634.jpg";
  }
...
export const productCategories: ProductCategory[] = [
  {
    ...
    iconName: "Camera",
    products: [
      { model: "CCTV-001", name: "CCTV Installation Service", specs: "Professional installation & maintenance", image: "/products/CCTV Installation Service.jpg" },
      { model: "CCTV-002", name: "HD & 4K IP Cameras", specs: "High-definition surveillance cameras", image: "/products/HD & 4K IP Cameras.jpg" },
      { model: "CCTV-003", name: "Night Vision & IR Cameras", specs: "24/7 monitoring capabilities", image: "/products/Night Vision & IR Cameras.jpg" },
      { model: "CCTV-004", name: "Cloud & Local Storage", specs: "Secure video storage solutions", image: "/products/Cloud & Local Storage.jpg" },
      { model: "CCTV-005", name: "Mobile App Monitoring", specs: "Remote access & monitoring", image: "/products/Mobile App Monitoring.jpg" },
    ],
  },
  {
    ...
    products: [
      { model: "BIO-001", name: "Fingerprint Recognition System", specs: "Advanced biometric access control", image: "/products/Fingerprint Recognition System.jpg" },
      { model: "BIO-002", name: "Face Recognition System", specs: "AI-powered face recognition", image: "/products/Face Recognition System.jpg" },
      { model: "BIO-003", name: "RFID Card Access", specs: "Card-based access control", image: "/products/RFID Card Access.jpg" },
      { model: "BIO-004", name: "Time & Attendance System", specs: "Employee attendance tracking", image: "/products/Time & Attendance System.jpg" },
      { model: "BIO-005", name: "Visitor Management System", specs: "Complete visitor tracking", image: "/products/Visitor Management System.jpg" },
    ],
  },
  {
    ...
    products: [
      ...
      { model: "VDP-003", name: "Remote Unlock System", specs: "Mobile app controlled access", image: "/products/Remote Unlock System.jpg" },
  ...
  },
  {
    ...
    iconName: "Home",
    products: [
      { model: "AUTO-001", name: "Smart Lighting Control", specs: "Automated lighting systems", image: "/products/Smart Lighting Control.jpg" },
      { model: "AUTO-002", name: "AC & Fan Automation", specs: "Climate control automation", image: "/products/AC & Fan Automation.jpg" },
      { model: "AUTO-003", name: "Motorized Curtains", specs: "Automated window treatments", image: "/products/Motorized Curtains.jpg" },
      { model: "AUTO-004", name: "Voice Control (Alexa/Google)", specs: "Voice-activated automation", image: "/products/Voice Control (Alexa,Google).jpg" },
      { model: "AUTO-005", name: "Scene & Schedule Settings", specs: "Custom automation scenes", image: "/products/Scene & Schedule Settings.jpg" },
    ],
  },
  {
    ...
    iconName: "DoorOpen",
    products: [
      { model: "GATE-001", name: "Sliding Gate System", specs: "Motorized sliding gates", image: "/products/Sliding Gate System.jpg" },
      { model: "GATE-002", name: "Swing Gate System", specs: "Automated swing gates", image: "/products/Swing Gate System.jpg" },
      { model: "GATE-003", name: "Remote Control Operation", specs: "Wireless remote control", image: "/products/Remote Unlock System.jpg" },
      { model: "GATE-004", name: "Safety Sensors", specs: "Obstacle detection sensors", image: "/products/Motion Sensors (PIR).jpg" },
  ...
  },
  {
    ...
    iconName: "Bell",
    products: [
      { model: "ALARM-001", name: "Motion Sensors (PIR)", specs: "Passive infrared sensors", image: "/products/Motion Sensors (PIR).jpg" },
      ...
      { model: "ALARM-005", name: "Mobile Notifications", specs: "Real-time alert system", image: "/products/Mobile Notifications.jpg" },
    ],
  },
  {
    ...
    products: [
      ...
      { model: "HW-005", name: "IT Support Services", specs: "Technical support & maintenance", image: "/products/IT Support Services.jpg" },
    ],
  },
  {
    ...
    iconName: "Code",
    products: [
      { model: "SW-001", name: "OS Installation & Setup", specs: "Windows, Linux, macOS", image: "/products/OS Installation & Setup.jpg" },
      { model: "SW-002", name: "Application Installation", specs: "Business & productivity software", image: "/products/Application Installation.jpg" },
      { model: "SW-003", name: "Software Troubleshooting", specs: "Fix software issues", image: "/products/Software Troubleshooting.jpg" },
      { model: "SW-004", name: "System Optimization", specs: "Performance enhancement", image: "/products/System Optimization.jpg" },
      { model: "SW-005", name: "Data Recovery Services", specs: "Recover lost data", image: "/products/Data Recovery Services.jpg" },
    ],
  },
  {
    ...
    products: [
      ...
      { model: "AV-002", name: "Conference Room Solutions", specs: "Complete AV setup", image: "/products/Conference Room Solutions.jpg" },
      { model: "AV-003", name: "PA & Sound Systems", specs: "Professional audio systems", image: "/products/PA & Sound Systems.jpg" },
      { model: "AV-004", name: "Interactive Displays", specs: "Touch-enabled displays", image: "/products/Interactive Displays.jpg" },
      { model: "AV-005", name: "Video Conferencing Setup", specs: "Remote meeting solutions", image: "/products/Video Conferencing Setup.jpg" },
    ],
  },
  {
    ...
    iconName: "Network",
    products: [
      { model: "NET-001", name: "LAN/WAN Setup", specs: "Local & wide area networks", image: "/products/LAN,WAN Setup.jpg" },
      { model: "NET-002", name: "Structured Cabling", specs: "Professional cable installation", image: "/products/Structured Cabling.jpg" },
      { model: "NET-003", name: "Network Infrastructure Design", specs: "Custom network planning", image: "/products/Network Infrastructure Design.jpg" },
      { model: "NET-004", name: "Network Troubleshooting", specs: "Network issue resolution", image: "/products/Network Troubleshooting.jpg" },
  ...
  },
  {
    ...
    products: [
      ...
      { model: "AMC-002", name: "Access Control AMC", specs: "Biometric system maintenance", image: "/products/Access Control AMC.jpg" },
      { model: "AMC-003", name: "Automation AMC", specs: "Smart home/office maintenance", image: "/products/Automation AMC.jpg" },
      { model: "AMC-004", name: "IT Infrastructure AMC", specs: "Computer & network maintenance", image: "/products/IT Infrastructure AMC.jpg" },
      { model: "AMC-005", name: "Complete System AMC", specs: "All-in-one maintenance package", image: "/products/Complete System AMC.jpg" },
    ],
  },
  {

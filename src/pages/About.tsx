...
const About = () => {
  return (
    <>
      ...
      <Layout>
        {/* Hero Section */}
        <section className="pt-16 md:pt-24 pb-6 md:pb-10 bg-hero relative overflow-hidden">
          <div 
          ...
          <div className="container-main relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-primary-foreground/70 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                A leading provider of integrated security and automation solutions, serving homes and businesses
